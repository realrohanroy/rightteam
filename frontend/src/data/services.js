...
export const SERVICES = [
  ...
  },
  {
    ...
    name: "Auditing",
    startingPrice: p(4999),
    oneLine: "Statutory, internal, and tax audits by experienced Chartered Accountants.",
    heroSummary:
      "Comprehensive auditing services including statutory audit, tax audit, internal audit, and GST audit to ensure 100% compliance and financial accuracy.",
    whatYouNeed: [
      "Books of accounts",
      "Bank statements and reconciliations",
      "Previous year's audit report",
      "Statutory registers and expense vouchers",
    ],
    process: filingProcess,
    framing: "loss",
    penalty: "Failure to get books audited on time can lead to a penalty of 0.5% of total sales or turnover, up to ₹1,50,000.",
    faqs: [],
  },
  {
